<template>
  ...
  <div
    class="flex flex-col-reverse xl:flex-row text-center content-center w-full mt-[150px] xl:mt-[180px] section"
    id="home"
  >
    <div
      class="flex flex-col space-y-6 content-center items-center xl:text-left xl:items-start max-w-[100vw]"
      data-aos="fade-down"
    ...
    >
      ...
      >
        Hello, my name is Michele.<br />
        I'm a <span id="language"></span>
      </p>

      <h1 class="text-[#bcbac4] w-[350px] text-[18px] max-w-full leading-6">
        A student from Italy who loves developing fullstack websites, designing
        and administrating systems.
      </h1>

      <button
        class="bg-[#235bdd] p-3 rounded-lg w-1/3 flex justify-center items-center h-[3rem]"
  ...
  <div class="pt-[175px] section" id="about">
    <div>
      ...
      <p class="text-[#bcbac4] text-[15px] text-center">
        Learn more about my life and experiences
      </p>
    </div>

    <div
      class="flex flex-col md:flex-row gap-x-10 items-center justify-center md:justify-between xl:justify-center w-fit md:w-11/12 xl:w-fit m-auto mt-[50px]"
      style="margin-top: 50px"
    >
      <img
        class="scale-75 md:scale-100"
        draggable="false"
        src="../assets/img/illustrationAbout.svg"
        alt="illustration"
      />
      ...
      <div
        ...
        data-aos-duration="1000"
      >
        <p class="text-[#bcbac4] text-[18px]">
          I'm a developer, designer and system administrator from Italy. I can
          design and create everything for you and your company.
        </p>

        <p class="text-[#bcbac4] text-[18px]">
          You can learn more about my skills and the languages I know below. I'm
          also the CEO at
          <a
            href="https://discord.gg/rocketcreations"
            class="font-bold bg-gradient-to-r from-blue-800 via-blue-600 to-blue-500 bg-clip-text text-transparent"
            >RocketCreations</a
          >
  ...
  <div class="mt-[85px] flex flex-col items-center section" id="skills">
    <div>
      ...
      <p class="text-[#bcbac4] text-[15px] text-center">Freelancing Skills</p>
    </div>

    <div
      class="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-8 mt-[50px] w-fit md:w-fit"
      data-aos="fade-down"
      data-aos-duration="1000"
    >
      <div class="w-fit">
        <div
          class="flex space-x-4 w-[320px] items-center cursor-pointer"
          @click="openDiv('frontend')"
        >
          <font-awesome-icon
            icon="code"
            style="
          ...
          <font-awesome-icon
            icon="angle-down"
            class="transition ease-in delay-100"
  ...
  <div class="mt-[85px] section" id="services">
    ...
    <div
      class="grid grid-cols-1 md:grid-cols-3 gap-x-6 mt-[50px] md:m-auto xl:m-0 xl:mt-[50px] md:w-11/12 xl:w-full"
    >
      <div
      ...
      >
        <font-awesome-icon icon="file-code" class="text-[#235bdd] fa-6x mt-4"></font-awesome-icon>
        <span class="text-[20px] font-bold">Web Development</span>

        <p class="text-center text-[#bcbac4]">
          I can create a modern and responsive fullstack website with Vue.js,
          HTML, CSS and Tailwind.
        </p>

        <button
          type="button"
          class="bg-[#235bdd] p-3 rounded-lg md:absolute bottom-[40px]"
          @click="redirect('https://imgur.com/a/EaduGMq')"
        >
          Check out my works
        </button>
      </div>
      ...
      <div
        class="text-[18px] md:text-unset scale-90 bg-[#2d2d3e] flex flex-col items-center h-[26rem] md:h-[30rem] gap-y-6 rounded-lg p-3 shadow relative transition ease-in-out delay-100 duration-200 hover:scale-90 md:hover:scale-95 hover:-translate-y-1 hover:-translate-x-1"
      >
        <font-awesome-icon icon="palette" class="text-[#235bdd] fa-6x mt-4"></font-awesome-icon>
        ...
        <button
          type="button"
          class="bg-[#235bdd] p-3 rounded-lg md:absolute bottom-[40px]"
          @click="redirect('https://imgur.com/a/qUaD557')"
        >
          Check out my works
        </button>
      </div>
      ...
      <div
        class="text-[18px] md:text-unset scale-90 bg-[#2d2d3e] flex flex-col items-center h-[26rem] md:h-[30rem] gap-y-6 rounded-lg p-3 shadow relative transition ease-in-out delay-100 duration-200 hover:scale-90 md:hover:scale-95 hover:-translate-y-1 hover:-translate-x-1"
      >
        <font-awesome-icon :icon="['fab', 'ubuntu']" class="text-[#235bdd] fa-6x mt-4"></font-awesome-icon>
        <span class="text-[20px] font-bold text-center"
          >System Administration</span
        >

        <p class="text-center text-[#bcbac4]">
          I can manage your system, install any program you need and maintain
          it.
        </p>
        ...
        <button
          type="button"
          class="bg-[#235bdd] p-3 rounded-lg md:absolute bottom-[40px]"
          @click="redirect('https://imgur.com/a/liBXrmE')"
        >
          Check out my works
        </button>
      </div>
  ...
  <div id="contact" class="section pt-[200px] flex flex-col">
    ...
    <div
      class="flex flex-col md:flex-row mt-[85px] md:mx-auto xl:mx-0 justify-around md:justify-between xl:justify-center md:w-11/12 xl:w-full"
    >
      <div class="flex flex-col justify-center w-full p-8 m-auto">
        <div
          class="w-full flex hover:bg-[#235bdd5b] border-[#235bdd] border-2 rounded-lg p-4 mb-4 transition ease-in-out delay-150 duration-300 cursor-pointer"
          @click="redirect('mailto:hello@michelemanna.me')"
        >
          <font-awesome-icon :icon="['far', 'envelope']" class="text-[25px]"></font-awesome-icon>
        ...
        >
          <font-awesome-icon :icon="['fab','discord']" class="text-[25px]"></font-awesome-icon>
        ...
        >
          <font-awesome-icon :icon="['fab','twitter']" class="text-[25px]"></font-awesome-icon>
          <p class="ml-[20px]">RocketCreations</p>
        </div>
      </div>

      <form
        class="w-full flex flex-col gap-[1.25rem] relative rounded-lg p-8 m-auto pb-0"
      ...
      >
        <div class="relative">
          ...
          <label
            for="name"
            class="absolute left-1 top-[0.30rem] p-1 text-white focus-anim-child rounded-lg bg-[#1c1c27]"
            >Name</label
          >
        </div>
        ...
        <button
          type="submit"
          class="bg-[#235bdd] p-3 rounded-lg relative bottom-[40px] mt-7"
        >
          <font-awesome-icon icon="paper-plane" class="mr-1"></font-awesome-icon> Submit
        </button>
      </form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    deleteText() {
      ...
      if (this.i > 0) {
        document.getElementById("language").innerHTML = txt.substring(
          0,
          this.i - 1
        );
        this.i--;
      ...
      setTimeout(() => {
        this.current =
          this.current < this.texts.length - 1 ? this.current + 1 : 0;
        this.typeWriter();
      }, 2000);
    },
    openDiv(name) {
  ...
  data() {
    return {
      texts: ["Web Dev.", "Designer.", "System Admin."],
      current: 0,
      i: 0,
      name: "",
      email: "",
...
.focus-anim-parent:not(:placeholder-shown).focus-anim-parent:not(:focus)
  ~ .focus-anim-child {
  top: -0.85rem;
  font-size: 0.8rem;
  left: 0.8rem;
